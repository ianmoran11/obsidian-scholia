...
- [x] 49. Evidence: 60s video; screenshot diff of central file.
...
- [x] 60. Verify visually: toggle between light/dark themes; each callout readable.
- [x] 61. Evidence: side-by-side light/dark screenshots.
